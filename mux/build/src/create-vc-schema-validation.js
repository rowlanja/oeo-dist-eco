...
const createVcWithLocalSchema = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //Schema validation
    const proofOfNameSchema = yield onyx_ssi_sdk_1.SchemaManager.getSchemaFromFile(path_1.default.resolve(`${__dirname}/schemas/${(0, lodash_1.camelCase)(credentialType)}.json`));
    const validation = yield onyx_ssi_sdk_1.SchemaManager.validateCredentialSubject(subjectData, proofOfNameSchema);
    if (validation) {
