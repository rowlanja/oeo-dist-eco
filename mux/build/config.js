...
//Keys
export const ISSUER_EDDSA_PRIVATE_KEY = getParam("ISSUER_EDDSA_PRIVATE_KEY") ||
...
export const HOLDER_EDDSA_PRIVATE_KEY = getParam("HOLDER_EDDSA_PRIVATE_KEY") ||
...
export const VC_DIR_PATH = getParam("VC_DIR_PATH") || "./src/verifiable_credentials";
export const VC = getParam("VC");
export const VC_ES256K_PRIVATE_KEY = getParam("VC_ES256K_PRIVATE_KEY");
//VP configs
export const VP_DIR_PATH = getParam("VP_DIR_PATH") || "./src/verifiable_presentation";
